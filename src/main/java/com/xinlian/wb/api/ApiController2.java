...
import com.xinlian.wb.api.util.ApiClassDoc;
import com.xinlian.wb.api.util.CommUtil;
...
//    }
     ...
     */
    public static String getMenuData(AnnotationParse annotationParse) {
        //调用解析方法
     ...
     */
    public static String getApiHome(AnnotationParse annotationParse) {
        //调用解析方法
        Map<String, Dict> dataMap = annotationParse.getApiData4Depth().getApiDataMap();
     ...
     */
    public static String getCalendarData(AnnotationParse annotationParse) {
        //调用解析方法
        Map<String, Dict> dataMap = annotationParse.getApiData4Depth().getApiDataMap();
     ...
     */
    public static String getWeekGroup(AnnotationParse annotationParse) {
        //调用解析方法
        Map<String, Dict> dataMap = annotationParse.getApiData4Depth().getApiDataMap();
        List<Dict> methodAll = Lists.newArrayList();
        dataMap.values().forEach(dict -> {
     ...
     * 模块分组
     */
    public static String getModelGroup(AnnotationParse annotationParse) {
        //调用解析方法
        Map<String, Dict> dataMap = annotationParse.getApiData4Depth().getApiDataMap();
     ...
     */
    public static String getAuthorGroup(AnnotationParse annotationParse) {
        //调用解析方法
        Map<String, Dict> dataMap = annotationParse.getApiData4Depth().getApiDataMap();
        List<Dict> methodAll = Lists.newArrayList();
        dataMap.values().forEach(dict -> {
     ...
     */
    public static String getMethodTitle(AnnotationParse annotationParse, String actionName, String method) {
     ...
     */
    public static String getReqParam(AnnotationParse annotationParse, String actionName, String method, String paramType) {
        String json = "";
     ...
     */
    public static String getPostManData(AnnotationParse annotationParse, String actionName, String method) {
        //调用解析方法
    ...
    public static Dict recursive(List<Dict> list) {
        Dict dict = Dict.create();
        if (list.isEmpty()) {
            return dict;
        } else {
    ...
    public static List<String> filterList(Dict dict, String pre) {
     ...
     * @return
     */
    public static String parseApiTableJson(List<String> paramList, BiConsumer<Dict, String> accumulator) {
    ...
    public static Dict getLastKv(List<Dict> list, List<String> keys) {
    ...
    public static Dict getKvByName(List<Dict> list, String name) {
        Dict kv = null;
        try {
...
//        Yaml yaml = new Yaml();
//        InputStream input = getClassLoader().getResourceAsStream("resources" + File.separator + "application.yml");
//        InputStreamReader reader = new InputStreamReader(input, Charset.forName("UTF-8"));
//        String url = reader.getEncoding();
//        if (url != null) {
//            try {
//                //获取test.yaml文件中的配置数据，然后转换为obj，
//                Object obj = yaml.load(new FileInputStream(""));
